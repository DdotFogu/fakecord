...
function MsgDetails({owner}: detailProps) {
    const { dms, removeDms } = useUsers();
    
    const display = owner.displayname
    const pfpUrl = owner.pfpUrl;
    ...
    <div className='flex flex-col border'>
        ...
        {display}
        <button
            onClick={() => removeDms(dms.indexOf(owner))}
        >
