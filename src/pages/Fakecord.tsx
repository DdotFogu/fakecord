    ...
    <>
      ...
      <span className="flex h-[calc(100%-32px)]">
        ...
        <aside className="flex">
          ...
          {/* Dms */}
          <div className="flex-1 border-x border-t border-dark-1  bg-dark-3 w-[364px] h-full flex flex-col items-center">
            ...
            <span className="w-full p-2 pb-3">
            ...
            <hr className="common-ruler w-[95%]"/>
        ...
        <main className="w-full flex flex-col">
          ...
          <header className="bg-dark-3 w-full h-12 border-y border-dark-1 flex flex-row items-center justify-end px-2 py-2 pl-3 gap-4">
            ...
            <span className="bg-dark-2 w-[244px] h-[32px] rounded-lg text-light-1 border border-dark-1 text-left items-center flex text-sm pl-2">
              Search typeeshitt33
          ...
          <div className="flex flex-row flex-1">
            <div className="bg-dark-1 w-full flex flex-col">
              ...
              {/* Message Footer */}
              <footer className="mx-1.5 mb-2 mt-auto bg-dark-2 h-[60px] w-[99%] rounded-lg border border-dark-1 flex flex-row items-center justify-end px-3.5 gap-4">
